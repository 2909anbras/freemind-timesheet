...
public class Job implements Serializable {
    ...
    public Job toolUsers(Set<ToolUser> toolUsers) {
        this.toolUsers = toolUsers;
        return this;
    }

    public Job addToolUser(ToolUser toolUser) {
        this.toolUsers.add(toolUser);
        toolUser.getJobs().add(this);
        return this;
    }

    public Job removeToolUser(ToolUser toolUser) {
        this.toolUsers.remove(toolUser);
        toolUser.getJobs().remove(this);
        return this;
    }
