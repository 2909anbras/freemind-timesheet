...
describe('Company e2e test', () => {
  ...
  it('should load Companies', async () => {
    ...
    expect(await companyComponentsPage.getTitle()).to.eq('freemindTimesheetApp.company.home.title');
  ...
  it('should load create Company page', async () => {
    ...
    expect(await companyUpdatePage.getPageTitle()).to.eq('freemindTimesheetApp.company.home.createOrEditLabel');
  ...
  it('should create and save Companies', async () => {
    ...
    await promise.all([companyUpdatePage.setNameInput('name')]);
  ...
  it('should delete last Company', async () => {
    ...
    expect(await companyDeleteDialog.getDialogTitle()).to.eq('freemindTimesheetApp.company.delete.question');
