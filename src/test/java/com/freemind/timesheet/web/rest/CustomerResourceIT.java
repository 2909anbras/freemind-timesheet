...
public class CustomerResourceIT {
    ...
    public static Customer createEntity(EntityManager em) {
        Customer customer = new Customer().name(DEFAULT_NAME).enable(DEFAULT_ENABLE);
        return customer;
    }
    ...
    public static Customer createUpdatedEntity(EntityManager em) {
        Customer customer = new Customer().name(UPDATED_NAME).enable(UPDATED_ENABLE);
        return customer;
    }
    ...
    public void getAllCustomersWithEagerRelationshipsIsEnabled() throws Exception {
        ...
        restCustomerMockMvc.perform(get("/api/customers?eagerload=true")).andExpect(status().isOk());
    ...
    public void updateCustomer() throws Exception {
        ...
        updatedCustomer.name(UPDATED_NAME).enable(UPDATED_ENABLE);
