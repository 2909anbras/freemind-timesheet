...
public class ProjectResourceIT {
    ...
    public static Project createEntity(EntityManager em) {
        Project project = new Project().name(DEFAULT_NAME).enable(DEFAULT_ENABLE);
        return project;
    }
    ...
    public static Project createUpdatedEntity(EntityManager em) {
        Project project = new Project().name(UPDATED_NAME).enable(UPDATED_ENABLE);
        return project;
    }
    ...
    public void updateProject() throws Exception {
        ...
        updatedProject.name(UPDATED_NAME).enable(UPDATED_ENABLE);
